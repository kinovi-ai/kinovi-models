#!/usr/bin/env python3
# text-to-image.py — Generate an image from a text prompt with GPT Image 2.5 Sunburst on Kinovi.
#
# Usage:
...
INPUTS = {
    ...
    "aspectRatio": "auto",  # auto | 1:1 | 4:3 | 3:4 | 16:9 | 9:16
    "resolution": "1k",     # 1k | 2k | 4k
    "quality": "low",       # low | medium | high | xhigh | max
...
API_BASE = os.environ.get("KINOVI_API_BASE", "https://kinovi.ai/api/v1")
