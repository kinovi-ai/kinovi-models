...
> Try it in the [Playground](https://kinovi.ai/app/gallery?model=gpt-image-2) · Full reference at [kinovi.ai/docs/models/gpt-image-2](https://kinovi.ai/docs/models/gpt-image-2) · Get an [API key](https://kinovi.ai/api-keys)
