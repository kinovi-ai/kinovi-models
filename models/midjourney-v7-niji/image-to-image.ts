// image-to-image.ts — Edit or restyle an existing image with Midjourney Niji V7 on Kinovi.
//
// Usage:
...
const MODEL = "midjourney-v7-niji";
const INPUTS = {
  prompt:
  ...
  // Max 1 publicly reachable image URL. Replace with your own.
