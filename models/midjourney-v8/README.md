...
| `inputs.quality` | `number` | – | Optional. `0.25` · `0.5` · `1`. |
...
Poll every couple of seconds until `status` is `success` or `fail`. Midjourney jobs often take a few minutes. On success, `output` has four images.
