<h1 align="center">Midjourney V8</h1>

<p align="center">
  Midjourney's image model on the Kinovi API. Text to image, or restyle one reference image.<br>
  Each task returns four images.
</p>

<p align="center">
  <img alt="Model id" src="https://img.shields.io/badge/model-midjourney--v8-6366f1?style=flat-square">
...
<p align="center">
  <a href="https://kinovi.ai/app/gallery?model=midjourney-v8">Playground</a> &nbsp;·&nbsp; <a href="https://kinovi.ai/docs/models/midjourney-v8">Full docs</a> &nbsp;·&nbsp; <a href="https://kinovi.ai/app/api-keys">Get an API key</a> &nbsp;·&nbsp; <a href="https://kinovi.ai/terms">Content policy</a>
</p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Generate four 1:1 images from a prompt</td>
...
Billed per task (four images). Live prices: [kinovi.ai/models/midjourney-v8](https://kinovi.ai/models/midjourney-v8).
...
<p align="center">
  ...
  <a href="https://kinovi.ai/models/midjourney-v8">Model page</a> &nbsp;·&nbsp;
  <a href="https://kinovi.ai/app/gallery?model=midjourney-v8">Playground</a>
</p>
