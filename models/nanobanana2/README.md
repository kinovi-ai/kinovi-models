...
> Try it in the [Playground](https://kinovi.ai/app/gallery?model=nanobanana2) · Full reference at [kinovi.ai/docs/models/nanobanana2](https://kinovi.ai/docs/models/nanobanana2) · Get an [API key](https://kinovi.ai/api-keys)
