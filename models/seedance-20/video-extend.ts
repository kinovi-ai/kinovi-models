// video-extend.ts — Continue an existing clip with Seedance 2.0 on Kinovi: pick up from its last frame and generate what happens next.
//
// Usage:
