// video-edit.ts — Edit an existing clip with Seedance 2.5 Video Edit on Kinovi: keep its motion and framing, change what is in it.
//
// Usage:
...
const MODEL = "seedance2-5-edit";
const INPUTS = {
  prompt:
    "Keep the same hand, the same slow hand movements and the same camera framing, but " +
