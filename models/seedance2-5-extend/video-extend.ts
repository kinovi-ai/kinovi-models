// video-extend.ts — Continue an existing clip with Seedance 2.5 Video Extend on Kinovi: pick up from its last frame and generate what happens next.
//
// Usage:
...
const MODEL = "seedance2-5-extend";
const INPUTS = {
  prompt:
