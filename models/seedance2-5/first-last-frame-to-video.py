#!/usr/bin/env python3
# first-last-frame-to-video.py — Generate a video that starts on one image and ends on another with Seedance 2.5 on Kinovi.
#
# Usage:
...
INPUTS = {
    ...
    # "mode": "keyframe" is the default for 1-2 images; it is set here to make the intent explicit.
    "imageUrls": [
    ...
    # The output keeps the images' aspect ratio; aspectRatio is not applied to keyframe tasks.
}
