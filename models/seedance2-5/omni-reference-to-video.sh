#!/usr/bin/env bash
# omni-reference-to-video.sh — Generate a video from several subject / style reference images with Seedance 2.5 on Kinovi.
#
# Usage:
...
#   bash omni-reference-to-video.sh
#
...
{
  "prompt": "A barista sets down the coffee cup from the reference images on a sunlit wooden counter, steam curling up, slow dolly-in, warm cinematic morning light.",
  "imageUrls": ["https://static.kinovi.ai/generated-images/2026-09-10/seedream_5_pro_1789011790741_0.png", "https://static.kinovi.ai/generated-images/2026-09-10/nanobanana_pro_1789012003511.png", "https://static.kinovi.ai/generated-images/2026-09-10/gpt_image_2_1789005123161_0.png"],
  "mode": "reference",
  "duration": 5,
...
EXT="${URL##*.}"; EXT="${EXT%%\?*}"
OUT="omni-reference-to-video.${EXT:-mp4}"
curl -sS -o "$OUT" "$URL"
echo "Saved $OUT  $URL"
