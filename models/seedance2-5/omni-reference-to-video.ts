// omni-reference-to-video.ts — Generate a video from several subject / style reference images with Seedance 2.5 on Kinovi.
//
// Usage:
...
const INPUTS = {
  ...
  // "mode": "reference" turns every image into a subject / style reference (up to 30).
  // You can mix in up to 10 videoUrls (motion / camera reference, 30 s combined) and
  // up to 10 audioUrls (soundtrack, 30 s combined) — audio must be combined with an image or video.
  imageUrls: [
