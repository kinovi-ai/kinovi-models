// first-last-frame-to-video.ts — Generate a video that starts on one image and ends on another with Seedance 2.0 Mini on Kinovi.
//
// Usage:
...
const INPUTS = {
  ...
  // Omit aspectRatio to follow the images' ratio; set 16:9 | 9:16 | 1:1 | 4:3 | 3:4 | 21:9 to force one.
};
