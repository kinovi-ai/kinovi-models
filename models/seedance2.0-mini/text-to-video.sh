#!/usr/bin/env bash
# text-to-video.sh — Generate a video from a text prompt with Seedance 2.0 Mini on Kinovi.
#
# Usage:
...
{
  "prompt": "A golden retriever running through autumn leaves in slow motion, cinematic depth of field, warm afternoon light, leaves swirling behind it.",
  "duration": 5,
