<h1 align="center">Wan 3.0 Image-to-Video</h1>

<p align="center">
  Alibaba's Wan 3.0 image-to-video on the Kinovi API. Animate one image as the opening frame, or give a first and a last frame and let the model fill in the motion.<br>
  2–30 second clips with a generated audio track, 480p to 1080p.
</p>

<p align="center">
  <img alt="Model id" src="https://img.shields.io/badge/model-wan3.0--image--to--video-6366f1?style=flat-square">
  ...
  <a href="https://kinovi.ai/models/wan3-image-to-video"><img alt="Model page" src="https://img.shields.io/badge/kinovi.ai-model%20page-111827?style=flat-square"></a>
</p>

> Try it in the [Playground](https://kinovi.ai/app/gallery?model=wan3.0-image-to-video) · Full reference at [kinovi.ai/docs/models/wan3.0-image-to-video](https://kinovi.ai/docs/models/wan3.0-image-to-video) · Get an [API key](https://kinovi.ai/app/api-keys)
...
```json
{
  "taskId": "task_au8l8iwm6egmm02mcvvuka39"
}
```
...
|:--|:--|:--|:--|
| `model` | `string` | **required** | Must be `"wan3.0-image-to-video"`. |
...
Wan 3.0 has three faces — text-to-video, image-to-video and reference-to-video — each in a standard and a Prime tier. [`wan3.0-prime-image-to-video`](../wan3.0-prime-image-to-video/README.md) takes the same inputs and finishes roughly twice as fast, at a higher per-second price. Switching is a one-line change of `model`. The other Wan 3.0 faces: [`wan3.0-text-to-video`](../wan3.0-text-to-video/README.md) · [`wan3.0-ref-to-video`](../wan3.0-ref-to-video/README.md).
...
```json
{
  ...
  "output": [
    {
      "url": "https://static.kinovi.ai/videos/wan3_1790101293171_d0ada64a.mp4",
      "width": 1280,
      "height": 720,
      "mediaType": "video/mp4"
    }
  ...
  "error": null,
  "createTime": 1790101157176,
  "completeTime": 1790101296719
}
```
...
Priced **per second of video**, by `outputResolution`. Reference images do not change the price. `duration` × the rate is charged at submit; failed tasks are refunded in full. Live prices: [kinovi.ai/models/wan3-image-to-video](https://kinovi.ai/models/wan3-image-to-video).
...
Example: the `image-to-video` and `first-last-frame-to-video` scripts generate 5 s at `720p` — **142.57 credits · $0.66** at list price (99.8 credits · $0.46 during the discount).

<br>

<p align="center">
  <a href="../../README.md">← All models</a> &nbsp;·&nbsp;
  <a href="https://kinovi.ai/models/wan3-image-to-video">Model page</a> &nbsp;·&nbsp;
  <a href="https://kinovi.ai/app/gallery?model=wan3.0-image-to-video">Playground</a>
</p>
