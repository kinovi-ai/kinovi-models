// image-to-video.ts — Animate a still image with Wan 3.0 on Kinovi.
//
// Usage:
...
const MODEL = "wan3.0-image-to-video";
const INPUTS = {
  prompt:
  ...
  // One image = opening frame. Add a second image to set the closing frame. Replace with your own URL.
