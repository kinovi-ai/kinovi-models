...
> Try it in the [Playground](https://kinovi.ai/app/gallery?model=wan3.0-prime-ref-to-video) · Full reference at [kinovi.ai/docs/models/wan3.0-prime-ref-to-video](https://kinovi.ai/docs/models/wan3.0-prime-ref-to-video) · Get an [API key](https://kinovi.ai/api-keys)
