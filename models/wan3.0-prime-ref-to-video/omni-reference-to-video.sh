#!/usr/bin/env bash
# omni-reference-to-video.sh — Build a shot from several reference images with Wan 3.0 Prime on Kinovi.
#
# Usage:
...
read -r -d '' INPUTS <<'JSON' || true
{
  ...
  "imageUrls": ["https://static.kinovi.ai/generated-images/2026-09-10/gpt_image_2_1789005123161_0.png", "https://static.kinovi.ai/generated-images/2026-09-10/nanobanana_pro_1789012003511.png", "https://static.kinovi.ai/generated-images/2026-09-10/seedream_5_pro_1789011790741_0.png"],
  "aspectRatio": "16:9",
  "duration": 5,
