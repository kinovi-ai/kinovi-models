...
{
  "prompt": "Follow the hand movement and camera framing of @Video1, but restyle it as claymation with warm studio lighting and a pastel backdrop.",
...
EXT="${URL##*.}"; EXT="${EXT%%\?*}"
OUT="reference-to-video.${EXT:-mp4}"
curl -sS -o "$OUT" "$URL"
echo "Saved $OUT  $URL"
