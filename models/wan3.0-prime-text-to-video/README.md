<h1 align="center">Wan 3.0 Prime Text-to-Video</h1>

<p align="center">
  Wan 3.0 Prime text-to-video on the Kinovi API — the faster Wan 3.0 tier. Describe a shot and get a clip with a generated audio track.<br>
  2–30 seconds, 480p to 1080p, five aspect ratios.
</p>

<p align="center">
  <img alt="Model id" src="https://img.shields.io/badge/model-wan3.0--prime--text--to--video-6366f1?style=flat-square">
  ...
  <a href="https://kinovi.ai/models/wan3-prime-text-to-video"><img alt="Model page" src="https://img.shields.io/badge/kinovi.ai-model%20page-111827?style=flat-square"></a>
</p>

> Try it in the [Playground](https://kinovi.ai/app/gallery?model=wan3.0-prime-text-to-video) · Full reference at [kinovi.ai/docs/models/wan3.0-prime-text-to-video](https://kinovi.ai/docs/models/wan3.0-prime-text-to-video) · Get an [API key](https://kinovi.ai/app/api-keys)
...
```json
{
  "taskId": "task_gvyxl8g6ppduut8yy86mvicy"
}
```
...
|:--|:--|:--|:--|
| `model` | `string` | **required** | Must be `"wan3.0-prime-text-to-video"`. |
...
Wan 3.0 has three faces — text-to-video, image-to-video and reference-to-video — each in a standard and a Prime tier. [`wan3.0-text-to-video`](../wan3.0-text-to-video/README.md) takes the same inputs at a lower per-second price and roughly twice the wait. Switching is a one-line change of `model`. The other Wan 3.0 Prime faces: [`wan3.0-prime-image-to-video`](../wan3.0-prime-image-to-video/README.md) · [`wan3.0-prime-ref-to-video`](../wan3.0-prime-ref-to-video/README.md).
...
Poll every few seconds until `status` is `success` or `fail`. A 5-second `720p` clip usually takes about 1.5 minutes. Longer clips and `1080p` take longer; poll for at least 15 minutes before treating a task as stuck.
...
```json
{
  ...
  "output": [
    {
      "url": "https://static.kinovi.ai/videos/wan3_1790101393285_f9da1621.mp4",
      "width": 1280,
      "height": 720,
      "mediaType": "video/mp4"
    }
  ...
  "error": null,
  "createTime": 1790101311097,
  "completeTime": 1790101398273
}
```
...
Priced **per second of video**, by `outputResolution`. `duration` × the rate is charged at submit; failed tasks are refunded in full. Live prices: [kinovi.ai/models/wan3-prime-text-to-video](https://kinovi.ai/models/wan3-prime-text-to-video).

| | 480p | 720p | 1080p |
|:--|--:|--:|--:|
| **per second** | $0.0877 · 18.86 cr | $0.1806 · 38.83 cr | $0.3611 · 77.66 cr |

Example: the `text-to-video` script generates 5 s at `720p` — **194.15 credits · $0.90**.

<br>

<p align="center">
  <a href="../../README.md">← All models</a> &nbsp;·&nbsp;
  <a href="https://kinovi.ai/models/wan3-prime-text-to-video">Model page</a> &nbsp;·&nbsp;
  <a href="https://kinovi.ai/app/gallery?model=wan3.0-prime-text-to-video">Playground</a>
</p>
